...
shared_lstm_1 = LSTM(64,return_sequences=True)
shared_lstm_2 = LSTM(64)
...
model.compile(optimizer='rmsprop',
              ...
              metrics=['accuracy'])
model.fit([train_query, train_doc], train_label, epochs=100,validation_data=([valid_query, valid_doc], valid_label))
pre=model.predict([test_query, test_doc])
print(pre)
model.save('dssm_lstm_3_model.h5')
